...
7. <strong>Md Tanvir Islam</strong> AND Samiul Bari "Accurate Prediction of Thyroid Cancer Recurrence using Advanced Machine Learning" <a href="[https://ieeeaccess.ieee.org/](https://confmiet.org/index.php)" target="_blank">MIET 2024</a> <strong>(Scopus Indexed)</strong>
