...
<p style="margin-top: 3px; margin-bottom:10px; font-size:12px;"><strong>AR:</strong> Acceptance Rate  | <strong>BK:</strong> Brain Korea | <strong>IF:</strong> Impact Factor | <strong><sup>*</sup></strong>Corresponding Author<br> |  <strong><sup>1</sup></strong>Equal Contributions<br></p>
<hr>
...
<hr>
Inzamamul ALam<sup>1</sup>, <strong>Md Tanvir Islam<sup>1</sup></strong>, and Simon S.Woo* "SADRE: Saliency-Aware Diffusion Reconstruction for Effective Invisible Watermark Removal" <a  class ="urls" href="https://www2025.thewebconf.org/short-papers" target="_blank">The Web Conference (WWW) 2025 (Rank A | Accepted).</a> <hr>
  </div>
  <div class="publication">
