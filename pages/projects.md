...
<div style="margin-top: 70px; display: flex; justify-content: flex-start;">
    ...
    <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
      ...
      <p style="margin-top:-7px;"><img src="https://cdn-icons-png.flaticon.com/512/4220/4220391.png" alt="Presentation Icon" width="15" height="15"><i>Accepted by ACM Multimedia 2024, Australia</i></p>
      ...
      <div style="margin-top: -30px; width: 40%; height:20px; text-align: center;">
...
<div style="margin-top: 30px; display: flex; justify-content: flex-start;">
    ...
    <div style="flex: 1; display: flex; flex-direction: column; gap: 20px;">
      ...
      <p style="margin-top:-7px;"><img src="https://cdn-icons-png.flaticon.com/512/4220/4220391.png" alt="Presentation Icon" width="15" height="15"><i>Accepted by Asian Conference on Computer Vision (ACCV 2024), Vietnam</i></p>
      <p style="text-align: justify; margin-top: 3px;">
